...
public class PublicarServicios extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pantalla_publicar_servicios);
        myToolbar = findViewById(R.id.toolbarServicios);
        ...
        botonSiguiente.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent i = new Intent(PublicarServicios.this, PantallaCargarImagenes.class);
